Public Class clsSerialNoSelection
    Inherits clsBase
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormType = frm_SerialNoGeneration Then
...
#Region "Validate Rows from Document"
    Private Function ValidaterowsFromDocument(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            aForm.Freeze(True)
            oMatrix = aForm.Items.Item("43").Specific
            For intRow As Integer = 1 To oMatrix.RowCount
                If oApplication.Utilities.getDocumentQuantity(oApplication.Utilities.getMatrixValues(oMatrix, "40", intRow)) > 0 Then
                    aForm.Freeze(False)
                    Return True
                End If
            Next
    ...
    Private Sub ClearSerialNumbers(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            aMatrix = aForm.Items.Item("43").Specific
            ...
            For intLoop As Integer = 1 To aMatrix.RowCount
                ...
                For intRow As Integer = oMatrix.RowCount To 1 Step -1
                    oMatrix.Columns.Item("51").Cells.Item(intRow).Click(SAPbouiCOM.BoCellClickType.ct_Regular)
